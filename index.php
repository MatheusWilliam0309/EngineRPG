...
<header class="fixed top-0 w-full z-50 flex justify-between items-center px-8 h-20 bg-surface/85 backdrop-blur-md border-b border-surface-bright/30 shadow-[0_4px_20px_rgba(255,181,154,0.07)]">
  <a href="#" class="font-headline text-2xl font-bold text-primary italic no-underline tracking-tight">Grimório Obsidiana</a>
  <nav class="hidden lg:flex items-center gap-8">
    <a href="./index.php" class="font-headline uppercase tracking-[0.12em] text-[0.78rem] no-underline transition-colors hover:text-[#f3e2ac] border-b-2 border-primary pb-1 text-primary">Grimório</a>
    <a href="./campanhas.php" class="font-headline text-secondary uppercase tracking-[0.12em] text-[0.78rem] no-underline transition-colors hover:text-[#f3e2ac]">Campanhas</a>
    <a href="./marketplace.php" class="font-headline text-secondary uppercase tracking-[0.12em] text-[0.78rem] no-underline transition-colors hover:text-[#f3e2ac]">Marketplace</a>
    <a href="./cronicas.php" class="font-headline text-secondary uppercase tracking-[0.12em] text-[0.78rem] no-underline transition-colors hover:text-[#f3e2ac]">Crônicas</a>
  </nav>
...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-20">
  ...
  <div class="relative z-10 text-center max-w-[60rem] mx-auto animate-[hero-in_1.2s_cubic-bezier(0.16,1,0.3,1)_both]">
    ...
    <div class="flex flex-wrap justify-center gap-4">
      <a href="./campanhas.php"><button class="px-10 py-4 bg-primary-container text-on-primary-container font-bold text-base rounded-sm shadow-[0_8px_24px_rgba(249,94,20,0.35)] transition-all tracking-wide cursor-pointer hover:brightness-110 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(249,94,20,0.45)]">Começar Campanha</button></a>
      <a><button class="px-10 py-4 bg-surface-container-high text-secondary font-bold text-base border border-outline/25 rounded-sm transition-all tracking-wide cursor-pointer hover:bg-surface-bright hover:-translate-y-1">Ver Grimório</button></a>
    </div>
  </div>
  ...
  <div class="max-w-[58rem] mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="bg-surface border border-outline-variant/50 rounded p-11 relative overflow-hidden transition-all duration-300 hover:border-outline hover:-translate-y-1 reveal">
        ...
        <button class="w-full p-4 bg-transparent border border-outline-variant/60 text-secondary font-bold text-[0.9rem] tracking-wide rounded cursor-pointer transition-all hover:bg-surface-container hover:border-outline hover:-translate-y-0.5">Iniciar Jornada</button>
      </div>
