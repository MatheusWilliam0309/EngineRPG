...
<body class="bg-surface text-on-surface font-body overflow-x-hidden scroll-smooth">

<header class="fixed top-0 w-full z-50 flex justify-between items-center px-8 h-20 bg-surface/85 backdrop-blur-md border-b border-surface-bright/30 shadow-[0_4px_20px_rgba(255,181,154,0.07)]">
  <a href="index.php?page=home" class="font-headline text-2xl font-bold text-primary italic no-underline tracking-tight">Grimório Obsidiana</a>
  <nav class="hidden lg:flex items-center gap-8">
    <a href="index.php?page=home" class="font-headline uppercase tracking-[0.12em] text-[0.78rem] no-underline transition-colors hover:text-[#f3e2ac] border-b-2 border-primary pb-1 text-primary">Grimório</a>
    <a href="index.php?page=campanhas" class="font-headline text-secondary uppercase tracking-[0.12em] text-[0.78rem] no-underline transition-colors hover:text-[#f3e2ac]">Campanhas</a>
    <a href="index.php?page=marketplace" class="font-headline text-secondary uppercase tracking-[0.12em] text-[0.78rem] no-underline transition-colors hover:text-[#f3e2ac]">Marketplace</a>
    <a href="index.php?page=cronicas" class="font-headline text-secondary uppercase tracking-[0.12em] text-[0.78rem] no-underline transition-colors hover:text-[#f3e2ac]">Crônicas</a>
  </nav>
  <div class="flex items-center gap-4">
    <button class="hidden md:block px-6 py-2 bg-primary text-on-primary font-bold text-[0.7rem] tracking-[0.18em] uppercase rounded-sm shadow-inner transition-all hover:scale-105 hover:brightness-110 cursor-pointer">Rolar Iniciativa</button>
...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden px-6 pt-20">
  ...
  <div class="relative z-10 text-center max-w-[60rem] mx-auto animate-[hero-in_1.2s_cubic-bezier(0.16,1,0.3,1)_both]">
    ...
    <h1 class="font-headline text-[clamp(2.8rem,8vw,6.5rem)] leading-[1.05] tracking-tight text-on-surface mb-6">Forje sua Lenda no <br/><em class="text-primary italic drop-shadow-[0_0_60px_rgba(255,181,154,0.3)]">Vácuo Obsidiano</em></h1>
    ...
    <div class="flex flex-wrap justify-center gap-4">
      <a href="index.php?page=campanhas"><button class="px-10 py-4 bg-primary-container text-on-primary-container font-bold text-base rounded-sm shadow-[0_8px_24px_rgba(249,94,20,0.35)] transition-all tracking-wide cursor-pointer hover:brightness-110 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(249,94,20,0.45)]">Começar Campanha</button></a>
      <a href="index.php?page=cronicas"><button class="px-10 py-4 bg-surface-container-high text-secondary font-bold text-base border border-outline/25 rounded-sm transition-all tracking-wide cursor-pointer hover:bg-surface-bright hover:-translate-y-1">Ver Crônicas</button></a>
    </div>
  </div>
  
  <div class="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1 opacity-40 animate-bob">
...
<section class="py-28 px-8 max-w-[90rem] mx-auto">
  ...
  <div class="grid grid-cols-1 md:grid-cols-12 gap-5">
    ...
    <div class="md:col-span-5 bg-surface-container border border-outline-variant/40 rounded flex flex-col items-center justify-center text-center p-12 relative overflow-hidden transition-all duration-300 group hover:border-outline/50 hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(0,0,0,0.4)] reveal reveal-delay-2">
      ...
      <span class="material-symbols-outlined text-tertiary text-6xl mb-6">devices</span>
  ...
  <div class="max-w-[58rem] mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="bg-surface border border-outline-variant/50 rounded p-11 relative overflow-hidden transition-all duration-300 hover:border-outline hover:-translate-y-1 reveal">
        ...
        <a href="index.php?page=campanhas"><button class="w-full p-4 bg-transparent border border-outline-variant/60 text-secondary font-bold text-[0.9rem] tracking-wide rounded cursor-pointer transition-all hover:bg-surface-container hover:border-outline hover:-translate-y-0.5">Iniciar Jornada</button></a>
      </div>
...
<section class="py-32 px-6 text-center relative overflow-hidden">
  ...
  <div class="relative z-10 reveal">
    ...
    <div class="inline-block p-1 bg-gradient-to-br from-primary to-primary-container rounded">
      <button class="block bg-surface px-14 py-5 font-bold uppercase tracking-[0.18em] text-[0.85rem] text-primary cursor-pointer border-none rounded transition-all hover:bg-transparent hover:text-on-primary">Forjar meu Destino</button>
    </div>
  </div>
</section>

<footer class="bg-surface-container-lowest border-t border-outline-variant/30 py-16 px-8 text-center">
  <span class="font-headline text-[1.6rem] font-bold italic text-primary block mb-8">Grimório Obsidiana</span>
  <nav class="flex flex-wrap justify-center gap-10 mb-10">
    <a href="#" class="text-[0.6rem] tracking-[0.25em] uppercase text-[#d6c692]/35 no-underline transition-colors hover:text-primary">Termos de Uso</a>
    <a href="#" class="text-[0.6rem] tracking-[0.25em] uppercase text-[#d6c692]/35 no-underline transition-colors hover:text-primary">Política de Privacidade</a>
    <a href="#" class="text-[0.6rem] tracking-[0.25em] uppercase text-[#d6c692]/35 no-underline transition-colors hover:text-primary">Suporte Arcano</a>
  </nav>
  <p class="text-[0.6rem] tracking-[0.2em] uppercase text-[#d6c692]/30">© 2024 Eldritch Editorial — Todos os direitos reservados aos escribas.</p>
</footer>

<script>
  /* Particles (Mantido do original) */
